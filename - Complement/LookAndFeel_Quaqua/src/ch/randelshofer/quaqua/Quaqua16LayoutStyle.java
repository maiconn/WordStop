...
import java.util.*;
/**
 * A Quaqua16LayoutStyle can be queried for the preferred gaps between two
 * JComponents, or between a JComponent and a parent Container.
 * <p>
 * To compile this class, you need Java 1.6.
 *
 * @author  Werner Randelshofer
 * @version $Id: Quaqua16LayoutStyle.java 174 2010-01-09 16:06:52Z wrandelshofer $
 */
public class Quaqua16LayoutStyle extends LayoutStyle {
    ...
    public int getPreferredGap(JComponent component1, JComponent component2,
        ...
        if (type == javax.swing.LayoutStyle.ComponentPlacement.INDENT) {
            ...
            Insets pgap = getPreferredGap(component1, javax.swing.LayoutStyle.ComponentPlacement.INDENT, sizeStyle);
            switch (position) {
