 ...
 * @version $Id: QuaquaScrollBarUI.java 174 2010-01-09 16:06:52Z wrandelshofer $
 */
public class QuaquaScrollBarUI extends BasicScrollBarUI {
    ...
    private boolean isSmall() {
        // If we are on a JScrollPane, we use the JScrollPane to
        // determine the size style. This is to prevent having
        // scroll bars with two different size styles on the same
        // JScrollPane.
